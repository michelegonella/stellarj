...
import com.consumimurigni.stellarj.crypto_cpp.SecretKeyCpp;
...
public class LocalNode {
	private static final Logger log = LogManager.getLogger();
		...
		protected final SecretKeyCpp mSecretKey;
		...
		public LocalNode(SecretKeyCpp secretKey, boolean isValidator, SCPQuorumSet qSet, SCP scp)
		{

...
import com.consumimurigni.stellarj.role.IOperation;
...
public class Transaction  {
  ...
  public void setOperations(IOperation[] value) {
  ...
  public static void encode(XdrDataOutputStream stream, Transaction encodedTransaction) throws IOException{
    ...
    for (int i = 0; i < operationssize; i++) {
    	IOperation.encode(stream, encodedTransaction.operations[i]);
    }
  ...
  public static Transaction decode(XdrDataInputStream stream) throws IOException {
    ...
    decodedTransaction.operations = new IOperation[operationssize];
    for (int i = 0; i < operationssize; i++) {
      decodedTransaction.operations[i] = IOperation.decode(stream);
    }

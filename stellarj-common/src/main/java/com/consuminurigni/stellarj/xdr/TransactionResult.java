...
import com.consumimurigni.stellarj.role.IOperationResult;
...
public class TransactionResult  {
  ...
  public static class TransactionResultResult {
    ...
    private IOperationResult[] results;
    public IOperationResult[] getResults() {
      return this.results;
    }
    public void setResults(IOperationResult[] value) {
      this.results = value;
    }
    ...
    for (int i = 0; i < resultssize; i++) {
    	IOperationResult.encode(stream, encodedTransactionResultResult.results[i]);
    }
    break;
    default:
    break;
    ...
    decodedTransactionResultResult.results = new IOperationResult[resultssize];
    for (int i = 0; i < resultssize; i++) {
      decodedTransactionResultResult.results[i] = IOperationResult.decode(stream);
    }
    break;
    default:
    break;

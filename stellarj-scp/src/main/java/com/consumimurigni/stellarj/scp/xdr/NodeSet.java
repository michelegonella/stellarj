...
public class NodeSet implements Collection<NodeID> {

	public boolean contains(PublicKey validator) {
	...
	public static final Comparator<NodeSet> BY_SIZE_COMPARATOR = new Comparator<NodeSet>() {
		@Override
	...
	public boolean add(PublicKey validator) {
		return add(validator.toNodeID());
